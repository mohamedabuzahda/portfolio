          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-12 mt-5 w-full max-w-6xl">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-base md:text-lg text-gray-300 mb-6 leading-relaxed">
                I'm a Junior software engineer specialized in ReactJS with 8
                months of hands-on experience building responsive,
                user-friendly, and modern web applications. Skilled in
                JavaScript, HTML, CSS, and React, with a passion for delivering
                seamless user experiences and solving real-world problems
                through clean, maintainable code.code.Recently graduated with a
                BSc in Information Technology and currently working as a
                WordPress Developer at Web Roots, combining frontend development
                expertise with CMS-based solutions to deliver scalable web
                projects.{" "}
              </p>
              <div className="flex flex-col gap-3 w-full md:w-auto">
                <button className="w-full md:w-[200px] h-12 md:h-14 bg-gradient-to-r from-cyan-400 to-blue-500 text-black font-bold py-2 px-4 rounded-lg hover:from-cyan-500 hover:to-blue-600 transition duration-300 shadow-lg hover:shadow-cyan-500/50 hover:shadow-xl text-sm md:text-base">
                  ...
                  >
                    <IoLogoWhatsapp className="text-xl md:text-2xl" /> Contact
                    WhatsApp
                  </a>
                </button>
                <button className="w-full md:w-[200px] h-12 md:h-14 bg-gradient-to-r from-cyan-400 to-blue-500 text-black font-bold py-2 px-4 rounded-lg hover:from-cyan-500 hover:to-blue-600 transition duration-300 shadow-lg hover:shadow-cyan-500/50 hover:shadow-xl text-sm md:text-base">
